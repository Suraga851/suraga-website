        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10">
            {content.experience.items.map((item) => (
              <div key={item.role} className="relative pr-8 border-r-2 border-brand-700/40">
                <div className="absolute -right-[9px] top-0 w-4 h-4 rounded-full bg-brand-600 border-4 border-surface-elevated" />
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <form className="space-y-4">
              ...
              <select className="w-full px-4 py-3 bg-surface-elevated border border-white/10 rounded-lg text-gray-300 focus:outline-none focus:border-brand-500 transition-colors">
                {locales.shared.inquiryOptions.map((opt) => (
