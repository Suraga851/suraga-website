...
const en = {
  ...
  services: {
    ...
    items: [
      { icon: "fa-universal-access", title: "Students of Determination Support", description: "Individualized learning plans, behavioral support, and accommodations for students with special educational needs in inclusive classrooms." },
      { icon: "fa-star", title: "Gifted & Talented Enrichment", description: "Advanced learning strategies, enrichment activities, and differentiated curriculum support for high-achieving students." },
      { icon: "fa-language", title: "Arabic/Islamic Studies Support", description: "Specialized support for Arabic language acquisition and Islamic Studies integration within international curriculum frameworks." },
      { icon: "fa-users", title: "Cross-Cultural Bridging", description: "Facilitating communication between Arabic-speaking families and international school staff, ensuring cultural sensitivity." },
      { icon: "fa-chart-line", title: "Literacy Intervention", description: "Evidence-based reading support using SPIRE and PAST assessment methodologies for struggling readers." },
      { icon: "fa-robot", title: "AI Literacy & Responsible AI Use", description: "Age-appropriate AI literacy sessions, prompt basics, fact-checking, citation habits, and safe/ethical use of AI tools for students and teachers." },
      { icon: "fa-graduation-cap", title: "Curriculum Support", description: "Assistance with British (Cambridge/IPC), American (Common Core), and IB curriculum delivery across all grade levels." },
    ],
  },
  experience: {
  ...
  testimonials: {
    ...
    items: [
      { quote: "Suraga's ability to connect with students of determination is remarkable. He creates an inclusive environment where every child feels valued and supported in their learning journey.", author: "Sarah Thompson", role: "SENCO, Dubai Schools Al Khawaneej", avatar: "ST" },
      { quote: "His bilingual skills have been invaluable in bridging communication between our Arabic-speaking families and the school. Parents feel heard and understood.", author: "Mohammed Al-Rashid", role: "Parent Relations Coordinator", avatar: "MA" },
      { quote: "Suraga's AI literacy workshops transformed how our teachers approach technology in the classroom. His patient, methodical approach makes complex concepts accessible.", author: "Dr. Emily Chen", role: "Head of Digital Learning", avatar: "EC" },
    ],
  },
  portfolio: {
    ...
    items: [
      ...
      { doc: "experience-letter-taaleem", title: "Taaleem Experience Letter", subtitle: "Dubai Schools Al Khawaneej", type: "pdf" },
      { doc: "recommendation-unity", title: "Unity High School Recommendation", subtitle: "Head of Primary", type: "pdf" },
      { doc: "secondary-certificate", title: "Sudanese Secondary Certificate", subtitle: "Ashariqa Private School", type: "cert" },
    ],
  },
  contact: {
    title: "Get In Touch",
    ...
    whatsappLink: "https://wa.me/971557177083?text=Hello%20Suraga,%20I%20found%20your%20website%20and%20would%20like%20to%20discuss%20opportunities.",
    ...
    form: {
      ...
      inquiryLabels: { job: "Job Inquiry", collaboration: "Collaboration", general: "General Question" },
    },
  },
  footer: {
    description: "Professional Learning Assistant and AI Literacy Assistant Teacher specializing in inclusive education and bilingual support for Dubai's international schools.",
...
const ar = {
  ...
  services: {
    ...
    items: [
      { icon: "fa-universal-access", title: "دعم أصحاب الهمم", description: "خطط تعلم فردية، دعم سلوكي، وتسهيلات للطلاب ذوي الاحتياجات التعليمية الخاصة في الفصول الشاملة." },
      { icon: "fa-star", title: "إثراء الموهوبين والمتفوقين", description: "استراتيجيات تعلم متقدمة، أنشطة إثرائية، ودعم منهجي متمايز للطلاب المتفوقين." },
      { icon: "fa-language", title: "دعم اللغة العربية/الدراسات الإسلامية", description: "دعم متخصص لاكتساب اللغة العربية ودمج الدراسات الإسلامية ضمن أطر المناهج الدولية." },
      { icon: "fa-users", title: "التواصل عبر الثقافات", description: "تسهيل التواصل بين الأسر الناطقة بالعربية وموظفي المدارس الدولية، مع ضمان الحساسية الثقافية." },
      { icon: "fa-chart-line", title: "التدخل في القراءة", description: "دعم القراءة القائم على الأدلة باستخدام منهجيات SPIRE وتقييم PAST للقراء المتعثرين." },
      { icon: "fa-robot", title: "محو الأمية في الذكاء الاصطناعي والاستخدام المسؤول", description: "جلسات عملية مناسبة للعمر حول مهارات الذكاء الاصطناعي، أساسيات صياغة الأوامر، التحقق من المعلومات، نسب المصادر، والاستخدام الآمن والأخلاقي للذكاء الاصطناعي." },
      { icon: "fa-graduation-cap", title: "دعم المناهج", description: "المساعدة في تقديم المنهج البريطاني (كامبريدج/IPC)، الأمريكي (Common Core)، والبكالوريا الدولية لجميع المراحل." },
    ],
  },
  experience: {
  ...
  testimonials: {
    title: "آراء الآخرين",
    items: [
      { quote: "قدرة سراجا على التواصل مع أصحاب الهمم رائعة. يخلق بيئة شاملة يشعر فيها كل طفل بالقيمة والدعم في رحلته التعليمية.", author: "سارة تومسون", role: "منسقة الاحتياجات الخاصة، مدارس دبي الخوانيج", avatar: "ST" },
      { quote: "مهاراته ثنائية اللغة كانت لا تقدر بثمن في جسر التواصل بين أسرنا الناطقة بالعربية والمدرسة. يشعر الآباء بالانصات والفهم.", author: "محمد الراشد", role: "منسق علاقات أولياء الأمور", avatar: "MA" },
      { quote: "حولت ورش عمل سراجا في محو الأمية في الذكاء الاصطناعي طريقة تعامل معلمينا مع التكنولوجيا في الفصل. منهجه المتأني والمنهجي يجعل المفاهيم المعقدة في متناول الجميع.", author: "د. إميلي تشن", role: "رئيسة التعلم الرقمي", avatar: "EC" },
    ],
  },
  portfolio: {
    ...
    items: [
      ...
      { doc: "experience-letter-taaleem", title: "خطاب خبرة تعليم", subtitle: "مدارس دبي الخوانيج", type: "pdf" },
      { doc: "recommendation-unity", title: "توصية مدرسة يونيتي", subtitle: "رئيس المرحلة الابتدائية", type: "pdf" },
      { doc: "secondary-certificate", title: "الشهادة الثانوية السودانية", subtitle: "مدرسة الشريقة الخاصة", type: "cert" },
    ],
  },
  contact: {
    title: "تواصل معي",
    ...
    whatsappLink: "https://wa.me/971557177083?text=مرحباً%20سراجا،%20وجدت%20موقعك%20وأود%20مناقشة%20الفرص.",
    ...
    form: {
      ...
      inquiryLabels: { job: "استفسار وظيفي", collaboration: "تعاون", general: "سؤال عام" },
    },
  },
  footer: {
    description: "مساعد تعليم محترف ومعلم محو الأمية في الذكاء الاصطناعي متخصص في التعليم الشامل والدعم ثنائي اللغة للمدارس الدولية في دبي.",
...
export const locales = { en, ar, shared };
