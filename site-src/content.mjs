...
export const locales = {
    en: {
        ...
        maintenance: {
            ...
            message:
                "Some sections may be temporarily unavailable while we improve performance and content quality. Thank you for your patience."
        },
        aria: {
            navPrimary: "Primary",
    ...
    ar: {
        ...
        maintenance: {
            ...
            message: "قد تكون بعض الأقسام غير متاحة مؤقتاً أثناء تحسين الأداء وجودة المحتوى. شكراً لتفهمكم."
        },
        aria: {
        ...
        meta: {
            title: "سراقة محمد - مساعد تعليم | دبي",
            description:
                "سراقة محمد - مساعد تعليم ومعلم محو الأمية في الذكاء الاصطناعي في دبي متخصص في التعليم الشامل، التدريس المختلف، والدعم العربي/الإسلامي للمدارس الدولية",
            keywords:
            ...
            ogTitle: "سراقة محمد - مساعد تعليم | دبي",
        ...
        testimonials: {
            ...
            items: [
                {
                    quote: "قدرة سراقة محمد على التواصل مع أصحاب الهمم رائعة. يخلق بيئة شاملة يشعر فيها كل طفل بالقيمة والدعم في رحلته التعليمية.",
                    author: "سارة تومسون",
                ...
                {
                    quote: "حولت ورش عمل سراقة محمد في محو الأمية في الذكاء الاصطناعي طريقة تعامل معلمينا مع التكنولوجيا في الفصل. منهجه المتأني والمنهجي يجعل المفاهيم المعقدة في متناول الجميع.",
                    author: "د. إميلي تشن",
        ...
        contact: {
            ...
            whatsappLink:
                "https://wa.me/971557177083?text=مرحباً%20سراقة%20محمد،%20وجدت%20موقعك%20وأود%20مناقشة%20الفرص.",
